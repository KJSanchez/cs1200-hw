...
void BatchTest(const char *filename, int num) {
  ...
  //   istr >> c >> i;
  //   assert(c == 'a');
  //   // here we dynamically (explicitly) allocate memory for the UndoArray
  //   object UndoArray<char> *ua = new UndoArray<char>(i);
